...
func (s *Service) RemediateFinding(caseID, findingID string, cmd RemediateCommand) (*domain.AccessionCase, error) {
	...
	return s.mutate(caseID, cmd.Context, "finding.remediated", payload, func(c *domain.AccessionCase) error {
...
func (s *Service) AssignFinding(caseID, findingID string, cmd AssignFindingCommand) (*domain.AccessionCase, error) {
	...
	return s.mutate(caseID, cmd.Context, "finding.assigned", payload, func(c *domain.AccessionCase) error { return c.AssignFinding(findingID, cmd.Assignee, cmd.DueAt) })
}
...
func (s *Service) AddFindingEvidence(caseID, findingID string, cmd AddEvidenceCommand) (*domain.AccessionCase, error) {
	...
	return s.mutate(caseID, cmd.Context, "finding.evidence_added", payload, func(c *domain.AccessionCase) error { return c.AddFindingEvidence(findingID, evidence) })
}
...
func (s *Service) CloseFinding(caseID, findingID string, cmd CloseFindingCommand) (*domain.AccessionCase, error) {
	...
	return s.mutate(caseID, cmd.Context, "finding.closed", map[string]any{"findingId": findingID}, func(c *domain.AccessionCase) error { return c.CloseFinding(findingID, cmd.Actor, cmd.Role, s.now()) })
}
